    ...
    Page.findPage(path, req.user, null, ignoreNotFound)
      .then(function(data) {
        ...
        if (data) {
          ...
          return Page.updatePage(data, body, req.user, { grant })
        } else {
          // new page
          updateOrCreate = 'create'
          return Page.create(path, body, req.user, { grant })
        }
      })
      .then(function(data) {
  ...
  api.create = function(req, res) {
    ...
    Page.findPage(pagePath, req.user, null, ignoreNotFound)
      .then(function(data) {
        ...
        return Page.create(pagePath, body, req.user, { grant })
      })
      .then(function(data) {
        if (!data) {
